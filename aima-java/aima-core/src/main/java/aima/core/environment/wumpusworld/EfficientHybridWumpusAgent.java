...
public class EfficientHybridWumpusAgent extends HybridWumpusAgent {
    ...
    public EfficientHybridWumpusAgent(int caveXDim, int caveYDim, AgentPosition start) {
        this(caveXDim, caveYDim, start, new TTEntails(), null);
    }

    public EfficientHybridWumpusAgent(int caveXDim, int caveYDim, AgentPosition start, InferenceProcedure solver,
                                      EnvironmentViewNotifier notifier) {
        this(caveXDim, caveYDim, start, new WumpusKnowledgeBase(caveXDim, caveYDim, start, solver), notifier);
    }
