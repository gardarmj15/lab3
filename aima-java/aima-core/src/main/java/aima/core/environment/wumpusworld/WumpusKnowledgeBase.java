...
public class WumpusKnowledgeBase extends KnowledgeBase {
    ...
    private InferenceProcedure prover;
    ...
    public WumpusKnowledgeBase(int caveXDim, int caveYDim) {
        this(caveXDim, caveYDim, new TTEntails());
    }

    public WumpusKnowledgeBase(int caveXDim, int caveYDim, InferenceProcedure prover) {
        this(caveXDim, caveYDim, new AgentPosition(1, 1, AgentPosition.Orientation.FACING_NORTH), prover);
    }
     ...
     */
    public WumpusKnowledgeBase(int caveXDim, int caveYDim, AgentPosition start, InferenceProcedure prover) {
        this.start = start;
        this.prover = prover;
...
//				}
    ...
    public boolean ask(Sentence query) {
        ...
        boolean result = prover.isEntailed(this, query);
