...
public class WumpusAgentApp extends IntegrableApplication {
    ...
    protected static String PARAM_SOLVER = "solver";
    ...
    protected List<Parameter> createParameters() {
        Parameter p1 = new Parameter(PARAM_CAVE, "2x2", "3x3", "4x4a", "4x4b", "5x5");
...
//        p2.setDefaultValueIndex(1);
    ...
    public void initialize() {
        ...
        InferenceProcedure solver = getSolver();
